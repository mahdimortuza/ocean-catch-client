...
const SubMenuSection = () => {
  return (
    <Container className="flex justify-between items-center gap-2  mt-5">
      <DropdownMenu>
        ...
        <DropdownMenuContent className="w-56">
          ...
          <DropdownMenuGroup>
            ...
            <Link href="">
              <DropdownMenuItem>Squid and Shrimps</DropdownMenuItem>
            </Link>
            <Link href="">
              <DropdownMenuItem>Big Fish</DropdownMenuItem>
            </Link>
            <Link href="">
